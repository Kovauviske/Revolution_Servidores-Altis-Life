...
_onScreenTime = 8; 
_role1 = 	"Bem vindo ao Altis Life Revolution";
_role1names = ["Respeite a todos"]; 
_role2 = 	"Utilize nosso TS:";
_role2names =["ts.revolutionservidores.com.br"];
_role3 = 	"Duvidas e Sugestões:";
_role3names =["ts.revolutionservidores.com.br"];
_role4 = 	"Aluguel de Servidores";
_role4names =["R$80,00/Mês."];
_role5 = 	"Informações";
_role5names =["ts.revolutionservidores.com.br ou contato@revolutionservidores.com.br"];
